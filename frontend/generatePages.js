    ...
    <div>
      ...
      <Card className="mb-6">
        ...
        <div className="flex justify-between items-center">
          <Button variant="outline"><Mic size={18} /> Record Answer</Button>
  ...
  return (
    <div>
      ...
      <Card className="mb-6">
        ...
        <div className="flex items-center justify-between p-4 mb-2 border rounded" style={{ borderColor: '#dfe1e6' }}>
          <div className="flex items-center gap-4">
            <CheckSquare className="text-primary" />
            <span style={{ textDecoration: 'line-through', color: 'var(--text-secondary)' }}>Complete React basics tutorial</span>
          </div>
        </div>
        <div className="flex items-center justify-between p-4 border rounded" style={{ borderColor: '#dfe1e6' }}>
          <div className="flex items-center gap-4">
